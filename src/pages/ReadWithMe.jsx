...
function ReadWithMe() {
  ...
  return (
    <div className="pb-16 space-y-8 pt-4">
      {/* Header Section */}
      <div className="mx-4 bg-brand-peach rounded-2xl text-brand-blue py-12 px-6 text-center shadow-md">
      ...
      <section id="notes" className="mx-4 bg-brand-blue border border-white/10 rounded-2xl p-6 sm:p-8 md:p-10 shadow-md">
        <div className="flex items-center justify-between border-b border-white/20 pb-3 mb-8">
          <h2 className="text-2xl font-bold tracking-tight sm:text-3xl text-brand-peach">
            Technical Notes
          </h2>
      ...
      <section id="articles" className="mx-4 bg-brand-peach rounded-2xl p-6 sm:p-8 md:p-10 shadow-md">
        <div className="flex items-center justify-between border-b border-brand-blue/20 pb-3 mb-8">
          <h2 className="text-2xl font-bold tracking-tight sm:text-3xl text-brand-blue">
            Articles & Writings
          </h2>
          <span className="text-xs font-semibold bg-brand-blue/10 px-3 py-1 rounded-full text-brand-blue">
